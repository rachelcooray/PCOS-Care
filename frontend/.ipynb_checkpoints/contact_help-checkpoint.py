...
def contact_help_page():
    ...
    **Phone**: +0123456789   
    ...
    We value your feedback! Please share your experience or suggestions with us to improve the app. 
    [Submit Feedback](#)  
    ...
    with st.expander("Can I get a detailed report of my risk assessment?"):
        st.markdown("""
        The tool provides a summary of your risk with a prediction and visualisation.
        """)
    ...
    with st.expander("Is my data safe?"):
        st.markdown("""
        Yes, privacy is taken seriously. Your data is securely stored and only used for risk assessment purposes. 
