...
def pcos_dashboard_page():
    ...
    st.markdown("""
        <div style='background-color: #E5D9F2; padding: 20px; border-radius: 10px; margin-bottom: 20px;'>
            ...
            <p><em>The statistics and insights presented here are based on comprehensive data analysis, to ensure that the information provided is insightful and also evidence-based.</em></p>
        </div>
    """, unsafe_allow_html=True)
